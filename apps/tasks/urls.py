...
from .views import (
    ...
    task_edit_view,
    task_list_view,
    task_remove_tag_view,
    task_toggle_complete_view,
    task_update_priority_view,
...
urlpatterns = [
    ...
    path("tasks/<int:pk>/update-priority/", task_update_priority_view, name="update_priority"),
    path("tasks/<int:pk>/tags/<int:tag_pk>/remove/", task_remove_tag_view, name="remove_tag"),
    path("tasks/<int:pk>/toggle-complete/", task_toggle_complete_view, name="toggle_complete"),
    path("tasks/comments/<int:pk>/delete/", comment_delete_view, name="comment_delete"),
    ...
    path("tasks/subtasks/<int:pk>/toggle/", subtask_toggle_view, name="subtask_toggle"),
